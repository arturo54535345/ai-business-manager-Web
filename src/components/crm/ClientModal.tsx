...
export default function ClientModal({ isOpen, onClose, clientToEdit }: ClientCardProps) {
    ...
    useEffect(() => {
        if (clientToEdit) {
            ...
            // Si el cliente es nuevo se limpian los campos
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    className="input-field bg-gray-50 focus:bg-white" placeholder="Ej. Ana García"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    className="input-field bg-gray-50 focus:bg-white" placeholder="Ej. Tech Solutions SL"
                                />
                            </div>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="input-field bg-gray-50 focus:bg-white" placeholder="ana@empresa.com"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="input-field bg-gray-50 focus:bg-white" placeholder="+34 600 000 000"
                                    />
                                </div>
                            </div>
                            <div>
